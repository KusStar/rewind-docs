...
1. 修复 低于 Android 12 进入部分页面（设置，今日推荐等）闪退的问题
...
1. 修复 歌手页、搜索、歌单、榜单接口请求问题

2. 修改 歌手页 专辑 Tab 修改为分类显示，分别为 专辑 与 Singles & EPs，点击 Tab 头切换显示，默认显示专辑内容

3. 优化 部分页面视觉显示效果优化

4. 优化 曲目匹配逻辑优化

5. targetSdkVersion 提升至 32
